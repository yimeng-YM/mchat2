...
export function QueueSettings() {
  ...
  return <div className="queue-settings chat-queue-settings">
    ...
    <div className="queue-mode-options" role="group" aria-label="消息队列模式">
      ...
      <button className={config.queueMode === 'manual' ? 'active' : ''} onClick={() => update('queueMode', 'manual')}><MessageSquareMore /><span><strong>手动提交</strong><small>输入框为空时点击发送按钮提交队列</small></span></button>
    </div>
